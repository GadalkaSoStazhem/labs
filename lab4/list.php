...
<div class = "prod-content">
    ...
    <div class = "prod-list" style="align-items: center">
        ...
        <a href="index.php?page_layout=create" style="width:30%;font-size: 24px; border-radius: 10px; background: #D89999; margin-left: 50%; margin-right: 50%; text-align: center;">
            Добавить букет
        </a>
